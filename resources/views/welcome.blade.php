...
@section('content')
    <div class="h-screen flex justify-center items-center">
        <div class="max-w-md w-full lg:flex h-64">
            <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded rounded-t lg:rounded lg:rounded-l text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
            </div>
